#!/bin/bash
#SBATCH --job-name=fit2_adhd_serum_iron_moksnes_2022
#SBATCH --error=/home/thales/MiXer/error/fit2_adhd_serum_iron_moksnes_2022_%A_%a.err
...
TRAIT2_FILE="/home/thales/MiXer/traitfolder/FerroSerico_Moksnes_2022_mixer.csv"

# Fit1 Parameters (per-chromosome)
TRAIT1_PARAMS="$BASE_DIR/results/fit1/adhd/adhd_modelfit1_${SLURM_ARRAY_TASK_ID}.json"
TRAIT2_PARAMS="/home/thales/MiXer/results/fit1/FerroSerico_Moksnes_2022_fit1_chr${SLURM_ARRAY_TASK_ID}.json"
...
# Output File
OUT_FILE="/home/thales/MiXer/results/fit2/fit2_adhd_FerroSerico_Moksnes_2022_${SLURM_ARRAY_TASK_ID}"
...
echo "🚀 Running MiXer FIT2: ADHD vs Serum Iron (Chromosome ${SLURM_ARRAY_TASK_ID})..."
