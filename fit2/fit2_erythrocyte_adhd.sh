#!/bin/bash
#SBATCH --job-name=fit2_erythrocyte_adhd
#SBATCH --error=/home/thales/MiXer/error/fit2_erythrocyte_adhd_%A_%a.err
...
TRAIT2_PARAMS="/home/thales/MiXer/results/fit1/erythrocyte/erythrocyte_modelfit1_${SLURM_ARRAY_TASK_ID}.json"

# Output File
OUT_FILE="/home/thales/MiXer/results/fit2/erythrocyte_adhd/erythrocyte_adhd_modelfit2_${SLURM_ARRAY_TASK_ID}"
mkdir -p "$(dirname "$OUT_FILE")"

echo "🚀 Running MiXer fit2 for Erythrocyte Count vs ADHD (Chromosome ${SLURM_ARRAY_TASK_ID})..."
