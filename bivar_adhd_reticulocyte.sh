#!/bin/bash
#SBATCH --job-name=bivar_adhd_reticulocyte
#SBATCH --error=/home/thales/MiXer/error/bivar_adhd_reticulocyte_%A_%a.err
...
TRAIT2_FILE="/home/thales/MiXer/traitfolder/reticulocyte_count_GSA.sumstats.gz"

FIT2_FILE="/home/thales/MiXer/results/fit2/reticulocyte_adhd/reticulocyte_adhd_modelfit2_${SLURM_ARRAY_TASK_ID}.json"

# Output File
OUT_FILE="/home/thales/MiXer/results/bivar/reticulocyte_adhd/reticulocyte_adhd_bivar_${SLURM_ARRAY_TASK_ID}"
mkdir -p "$(dirname "$OUT_FILE")"

echo "🚀 Running MiXer test2 (bivar) for ADHD vs Reticulocyte Count (Chromosome ${SLURM_ARRAY_TASK_ID})..."
