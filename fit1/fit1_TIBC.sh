#!/bin/bash
#SBATCH --job-name=mixer_fit1_TIBC_Moksnes_2022
#SBATCH --error=/home/thales/MiXer/error/mixer_fit1_TIBC_Moksnes_2022_%A_%a.err
...
TRAIT_FILE="$TRAIT_DIR/TIBC_Moksnes_2022_mixer.csv"
TRAIT_NAME="TIBC_Moksnes_2022"
