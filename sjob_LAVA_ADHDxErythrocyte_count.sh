#!/bin/bash
#SBATCH --job-name=ADHDxErythrocyte_count    # Job name


#SBATCH --ntasks=1                    # Run on a single CPU
#SBATCH --mem=30gb                     # Job memory request
#SBATCH --time=192:00:00               # Time limit hrs:min:sec
#SBATCH --output=/home/thales/LAVA/results/Uk/LAVA_ADHDxErythrocyte_count%j.log   # Standard output and error log
pwd; hostname; date
...
"ADHD;Erythrocyte_count" \
"/home/thales/LAVA/results/Uk/14.04.2026-LAVA_ADHDxErythrocyte_count"
