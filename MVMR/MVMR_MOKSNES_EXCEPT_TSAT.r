...
saveRDS(res_rev, file = "res_Ferro.rds")
...
write.csv(mapping, "Mapping_Exposures_Names_GRUPO1.csv", row.names = FALSE)
...
# Save diagnostics
write.csv(sres, "Fstat_Ferro.csv")
write.csv(pres, "Qstat_Ferro.csv")
