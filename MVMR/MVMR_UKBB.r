...
saveRDS(res_rev, file = "res_Ferro_UKBB.rds")
...
write.csv(mapping, "Mapping_Exposures_Names_GRUPO2.csv", row.names = FALSE)
...
# Save diagnostics
write.csv(sres, "Fstat_Ferro_UKBB.csv")
write.csv(pres, "Qstat_Ferro_UKBB.csv")
