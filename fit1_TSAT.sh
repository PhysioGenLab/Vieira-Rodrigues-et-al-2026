#!/bin/bash
#SBATCH --job-name=mixer_fit1_TSAT_Moksnes_2022
#SBATCH --error=/home/thales/MiXer/error/mixer_fit1_TSAT_Moksnes_2022_%A_%a.err
...
TRAIT_FILE="$TRAIT_DIR/TSP_Moksnes_2022_mixer.csv"
TRAIT_NAME="TSP_Moksnes_2022"
