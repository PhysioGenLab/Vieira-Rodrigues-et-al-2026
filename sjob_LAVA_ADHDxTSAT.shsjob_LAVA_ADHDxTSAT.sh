#!/bin/bash
#SBATCH --job-name=ADHDxTSAT_Moksnes    # Job name


#SBATCH --ntasks=1                    # Run on a single CPU
#SBATCH --mem=30gb                     # Job memory request
#SBATCH --time=192:00:00               # Time limit hrs:min:sec
#SBATCH --output=/home/thales/LAVA/LAVA_ADHDxMoksnes/LAVA_ADHDxTSAT_Moksnes%j.log   # Standard output and error log
pwd; hostname; date
...
"ADHD;TSP" \
"/home/thales/LAVA/LAVA_ADHDxMoksnes/19.02.2025-LAVA_ADHDxTSAT_Moksnes"
