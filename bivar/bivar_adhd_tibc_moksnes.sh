#!/bin/bash
#SBATCH --job-name=bivar_adhd_tibc_moksnes
#SBATCH --error=/home/thales/MiXer/error/bivar_adhd_tibc_moksnes_2022_%A_%a.err
...
TRAIT1_FILE="/home/thales/MiXer/traitfolder/TIBC_Moksnes_2022_mixer.csv"
TRAIT2_FILE="$BASE_DIR/jobs/ADHD_mixer.csv.gz"

# Fit2 Parameters (per-chromosome)
TRAIT1_PARAMS="/home/thales/MiXer/results/fit2/fit2_adhd_TIBC_Moksnes_2022_${SLURM_ARRAY_TASK_ID}.json"
...
# Output File
OUT_FILE="/home/thales/MiXer/results/bivar/bivar_adhd_MOKSNES/bivar_adhd_TIBC_Moksnes_2022_${SLURM_ARRAY_TASK_ID}"
...
echo "🚀 Running MiXer test2 (bivar) for TIBC vs ADHD (Chromosome ${SLURM_ARRAY_TASK_ID})..."
