#!/bin/bash
#SBATCH --job-name=bivar_adhd_hb
#SBATCH --error=/home/thales/MiXer/error/bivar_adhd_hb_%A_%a.err
...
FIT2_FILE="/home/thales/MiXer/results/fit2/hb_adhd/hb_adhd_modelfit2_${SLURM_ARRAY_TASK_ID}.json"

# Output File
OUT_FILE="/home/thales/MiXer/results/bivar/hb_adhd/hb_adhd_bivar_${SLURM_ARRAY_TASK_ID}"
mkdir -p "$(dirname "$OUT_FILE")"

echo "🚀 Running MiXer test2 (bivar) for ADHD vs Hb (Chromosome ${SLURM_ARRAY_TASK_ID})..."
