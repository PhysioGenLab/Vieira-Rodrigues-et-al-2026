#!/bin/bash
#SBATCH --job-name=fit1_erythrocyte
#SBATCH --error=/home/thales/MiXer/error/fit1_error/erythrocyte_%A_%a.err
...
singularity exec --cleanenv --bind /home/nico,/home/thales /home/nico/Mixer2/mixer/mixer-1.3.0/singularity/mixer_newer2.sif python /tools/mixer/precimed/mixer.py fit1 \
      --trait1-file /home/thales/MiXer/traitfolder/erythrocyte_count_GSA.sumstats.gz \
      --out /home/thales/MiXer/results/fit1/erythrocyte/erythrocyte_modelfit1_${SLURM_ARRAY_TASK_ID} \
